...
you will need to apply all design fixes to programs as well:

fix css on programs to handle thumbs the way designs do.
also program view box needs a min height otherwise text gets wierd.




test blog gallery features

def going to need a link to edit each program only if signed in DEVISE.

factor out controller stuff into methods in models
