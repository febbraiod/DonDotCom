...
post has one gallery, gallery has many images
design has one gallery ect...
...
blog show page will have content in left column content will ref images (see img 1)

second column with have images from gallery with images label 1.1, 1.2
